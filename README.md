...
DeepSeek 官方同款 3D 粒子鲸鱼插件（Three.js WebGL），专为 **DeepSeek Harness (DSH)** 及 **DSH Desktop** 原生打造。
...
- ⚡️ **闲置 vs 思考/工作极光动态对比**：
  - **闲置时**：深海慢速悠闲巡游（`0.9x`），尾鳍轻摇；
  - **思考/生成/执行工具中**：**3.5 倍高速动力推进**（`2.6x`），尾鳍大力打水，身躯激荡正弦浪涌，全身亮起青蓝生物电脉冲流光。
